...
_agent_turn_context: ContextVar[TurnContext] = ContextVar(
    "microsoft_agents.hosting.teams.teams_sdk.agent_turn_context"
)


def agent_turn_context() -> TurnContext:
    ...
    """
    return _agent_turn_context.get()


__all__ = ["agent_turn_context"]
